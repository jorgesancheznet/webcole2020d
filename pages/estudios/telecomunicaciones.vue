<template>
  <main>
    <TituloGrande imagen="/img/ciclos/fondo-teleco.jpg" titulo="Instalaciones de Telecomunicaciones" subtitulo="FP de Grado Medio" />
    <SeccionOpaca>
      <FilaContenido>
        <ColumnaContenido>
...
export default {
  ...
  head(){
    return{
        title:"Ciclo de FPO de Grado medio en Telecomunicaciones, Salesianos Centro Don Bosco de Villamuriel de Cerrato"
    }
  },
  components: {
    ContenedorFotos,
